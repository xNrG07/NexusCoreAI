      ...
      <footer className="relative z-10 mt-8 border-t border-slate-800/50 bg-[#0a0a0c] py-6 sm:mt-12">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <FooterLink href="/impressum.html" icon={FileText}>Impressum</FooterLink>
            <FooterLink href="/datenschutz.html" icon={Shield}>Datenschutz</FooterLink>
            <FooterLink href="/cookies.html" icon={Cookie}>Cookies</FooterLink>
          </div>
        </div>
      </footer>
    </div>
